...
//    var implimentations = makeFile.match(/#LIBAV:=.*/g).toString().replace(/#LIBAV:=/g, '');
//    rl.question("Enter your libav implementation. Supported libav implimentations are: " + implimentations + ': '
//            , function(selection) {
//
